...
$sql = "SELECT b.*, c.course_name FROM `business_books` b LEFT JOIN course c ON b.course_id = c.course_id";
...
<div class="row">
    ...
    if ($result->num_rows > 0) {
        ...
        ?>
        <div class="col-md-12">
            <p>No books available in the Business Studies department.</p>
        </div>
        <?php
    }
    ?>
