...
<div class="col-sm-9 mt-5">
    <div class="payment-container">
        <h3 class="payment-header">Course Order Payment Status</h3>
        ...
        <div class="table-responsive payment-table">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM courseorder $where_clause ORDER BY order_date DESC LIMIT 15";
                    ...
                    if($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo '<tr>
                                    ...
                                    <td>'.substr($row['respomsg'], 0, 20).'...</td>
                                    <td>
                                       <a href="adminViewDetails.php?order_id='.$row['order_id'].'" class="btn btn-sm btn-info action-btn" title="View Details">
                                         <i class="fas fa-eye"></i>
                                         </a>
                                        <a href="adminUpdateStatus.php?order_id='.$row['order_id'].'" class="btn btn-sm btn-warning action-btn" title="Update Status">
                        ...
                        echo '<tr>
                                <td colspan="8" class="text-center py-4">No course order records found</td>
                              </tr>';
                    }
                    $stmt->close();
                    ?>
